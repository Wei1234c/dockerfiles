...
docker build -t wei1234c/oracle-java8_armv7 /dockerfiles/ARMv7/java/oracle-java8
docker build -t wei1234c/oracle-java8_sshd_armv7 /dockerfiles/ARMv7/java_sshd
...
docker build -t wei1234c/haproxy_armv7 /dockerfiles/ARMv7/haproxy
...
docker push wei1234c/oracle-java8_armv7
docker push wei1234c/oracle-java8_sshd_armv7
